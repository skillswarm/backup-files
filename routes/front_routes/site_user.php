...
Route::get('my-recommendations', 'UserController@myRecommendations')->name('my.recommendations');
Route::get('my-timeline', 'UserController@myTimeline')->name('my.timeline');
Route::post('store-reply', 'UserController@saveReply')->name('my.messages.reply');
