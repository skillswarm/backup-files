...
Route::get('create-multiple-users', array_merge(['uses' => 'Admin\DataImportController@index'], $all_users))->name('create.multiple.user');
Route::post('import', array_merge(['uses' => 'Admin\DataImportController@import'], $all_users))->name('user.import');
