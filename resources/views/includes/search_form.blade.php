...
<form action="{{route('job.seeker.list')}}" method="get">
    <div class="searchbar">
        ...
        @else
        <div class="col-md-3">
            {!! Form::select('country_id[]', ['' => __('Select Country')]+$countries, Request::get('country_id', 101), array('class'=>'form-control', 'id'=>'country_id')) !!}
        </div>
        @endif
      ...
      <!-- <button type="submit">{{__('Search Job Seeker')}}<i class="la la-search"></i></button> -->
			<input type="submit" class="btn" value="{{__('Search Job Seeker')}}" style="background-color: #0f36a5;color: white;height: 100%;">
		  </span>
		</div>
		</div>
...
<form action="{{route('job.list')}}" method="get">
    ...
    <div class="searchbar">
		...
		<div class="input-group" style="margin-top: 10px;">
		  ...
		  <span class="input-group-btn">
			<input type="submit" class="btn" value="{{__('Search Job')}}" style="background-color: #0f36a5;color: white;height: 100%;">
		  </span>
		</div>
		</div>
    </div>
