...
{!! Form::model($mentor, array('method' => 'post', 'route' => array('mentor.updateProfile'), 'class' => 'form', 'files'=>true)) !!}
<h6>{{__('Profile Image')}}</h6>
<div class="row">
    <div class="col-md-6">
        <div class="formrow"> {{ ImgUploader::print_image("mentor_images/$mentor->image", 100, 100) }} </div>
    </div>
    <div class="col-md-6">
        <div class="formrow">
            <div id="thumbnail"></div>
            <label class="btn btn-default" style="padding-bottom: 30px;"> {{__('Select Profile Image')}}
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'country_id') !!}">
            <?php $country_id = old('country_id', (isset($mentor) && (int) $mentor->country_id > 0) ? $mentor->country_id : 101); ?>
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'nationality_id') !!}"> {!! Form::select('nationality_id', [''=>__('Select Nationality')]+$nationalities, 101, array('class'=>'form-control', 'id'=>'nationality_id')) !!}
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'salary_currency') !!}">
            @php
            $salary_currency = Request::get('salary_currency', (isset($mentor) && !empty($mentor->salary_currency))? $mentor->salary_currency:'INR');
            @endphp
	...
	if (old('is_subscribed', ((isset($mentor)) ? $mentor->is_subscribed : 1)) == 0) {
		$is_checked = '';
	}
	?>
      </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        filterStates(<?php echo old('state_id', $mentor->state_id); ?>);
        ...
        if (country_id != '') {
            $.post("{{ route('filter.lang.states.dropdown') }}", {country_id: country_id, state_id: state_id, _method: 'POST', _token: '{{ csrf_token() }}'})
                    .done(function (response) {
                        ...
                        filterCities(<?php echo old('city_id', $mentor->city_id); ?>);
                    });
        }
    }
