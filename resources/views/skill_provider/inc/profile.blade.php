<h5>{{__('Skill Provider Information')}}</h5>
{!! Form::model($skill_provider, array('method' => 'post', 'route' => array('skill-provider.updateProfile'), 'class' => 'form', 'files'=>true)) !!}
<h6>{{__('Logo')}}</h6>
<div class="row">
    <div class="col-md-6">
        <div class="formrow"> {{ ImgUploader::print_image("skill_provider_images/$skill_provider->logo", 100, 100) }} </div>
    </div>
    <div class="col-md-6">
        <div class="formrow">
            <div id="thumbnail"></div>
            <label class="btn btn-default" style="height: 45px;"> {{__('Select Logo')}}
...
<div class="row">
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'name') !!}"> {!! Form::text('name', null, array('class'=>'form-control', 'id'=>'name', 'placeholder'=>__('Name'))) !!}
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'fax') !!}"> {!! Form::text('fax', null, array('class'=>'form-control', 'id'=>'fax', 'placeholder'=>__('Mobile Number'))) !!}
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'country_id') !!}"> {!! Form::select('country_id', ['' => __('Select Country')]+$countries, 101, array('class'=>'form-control', 'id'=>'country_id')) !!}
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        filterLangStates(<?php echo old('state_id', (isset($skill_provider)) ? $skill_provider->state_id : 0); ?>);
        ...
        if (country_id != '') {
            $.post("{{ route('filter.lang.states.dropdown') }}", {country_id: country_id, state_id: state_id, _method: 'POST', _token: '{{ csrf_token() }}'})
                    .done(function (response) {
                        ...
                        filterLangCities(<?php echo old('city_id', (isset($skill_provider)) ? $skill_provider->city_id : 0); ?>);
                    });
        }
    }
