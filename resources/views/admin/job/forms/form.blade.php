...
<div class="form-body">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'company_id') !!}" id="company_id_div">
        {!! Form::label('company_id', 'Employer', ['class' => 'bold']) !!}
        {!! Form::select('company_id', ['' => 'Select Employer']+$companies, null, array('class'=>'form-control', 'id'=>'company_id')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'country_id') !!}" id="country_id_div">
        ...
        {!! Form::select('country_id', ['' => 'Select Country']+$countries, old('country_id', (isset($job))? $job->country_id:101), array('class'=>'form-control', 'id'=>'country_id')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'salary_currency') !!}" id="salary_currency_div">
        ...
        {!! Form::select('salary_currency', ['' => 'Select Salary Currency']+$currencies, 'INR', array('class'=>'form-control', 'id'=>'salary_currency')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'salary_period_id') !!}" id="salary_period_id_div">
        ...
        {!! Form::select('salary_period_id', ['' => 'Select Salary Period']+$salaryPeriods, 1, array('class'=>'form-control', 'id'=>'salary_period_id')) !!}
