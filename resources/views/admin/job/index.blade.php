                                ...
                                <table class="table table-striped table-bordered table-hover"  id="jobDatatableAjax">
                                    <thead>
                                        <tr role="row" class="filter">
                                            <td>{!! Form::select('company_id', ['' => 'Select Employer']+$companies, null, array('id'=>'company_id', 'class'=>'form-control')) !!}</td>
                                            ...
                                            <td>
                                                ...
                                                {!! Form::select('country_id', ['' => 'Select Country']+$countries, 101, array('id'=>'country_id', 'class'=>'form-control')) !!}
