...
@if(isset($mentor))
{!! Form::model($mentor, array('method' => 'put', 'route' => array('update.mentor', $mentor->id), 'class' => 'form', 'files'=>true)) !!}
{!! Form::hidden('id', $mentor->id) !!}
@else
{!! Form::open(array('method' => 'post', 'route' => 'store.mentor', 'class' => 'form', 'files'=>true)) !!}
@endif
<div class="form-body">
    ...
    <div class="row">
        ...
        @if(isset($mentor))
        <div class="col-md-6">
            {{ ImgUploader::print_image("mentor_images/$mentor->image") }}
        </div>
        @endif
    </div>
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'nationality_id') !!}">
        ...
        {!! Form::select('nationality_id', [''=>'Select Nationality']+$nationalities, 101, array('class'=>'form-control', 'id'=>'nationality_id')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'salary_currency') !!}">
        ...
        {!! Form::text('salary_currency', 'INR', array('class'=>'form-control', 'id'=>'salary_currency', 'placeholder'=>'Salary Currency', 'autocomplete'=>'off')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'is_active') !!}">
        ...
        <div class="radio-list">
            ...
            $is_active_2 = '';
            if (old('is_active', ((isset($mentor)) ? $mentor->is_active : 1)) == 0) {
                $is_active_1 = '';
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'verified') !!}">
        ...
        <div class="radio-list">
            ...
            $verified_2 = '';
            if (old('verified', ((isset($mentor)) ? $mentor->verified : 1)) == 0) {
                $verified_1 = '';
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        filterDefaultStates(<?php echo old('state_id', (isset($mentor)) ? $mentor->state_id : 0); ?>);
    });
        ...
        if (country_id != '') {
            $.post("{{ route('filter.default.states.dropdown') }}", {country_id: country_id, state_id: state_id, _method: 'POST', _token: '{{ csrf_token() }}'})
                    .done(function (response) {
                        ...
                        filterDefaultCities(<?php echo old('city_id', (isset($mentor)) ? $mentor->city_id : 0); ?>);
                    });
        }
    }
