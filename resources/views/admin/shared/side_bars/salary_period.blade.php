<li class="nav-item {{ (request()->segment(2) == 'list-salary-periods'||request()->segment(2) == 'create-salary-periode'||request()->segment(2) == 'sort-salary-periods') ? 'open active' : '' }} "> <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-money" aria-hidden="true"></i> <span class="title">Salary Periods</span> <span class="arrow"></span> </a>
    <ul class="sub-menu">
