<li class="nav-item {{ (request()->segment(2) == 'list-countries'||request()->segment(2) == 'create-country'||request()->segment(2) == 'sort-countries') ? 'open active' : '' }} "> <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-globe" aria-hidden="true"></i> <span class="title">Countries</span> <span class="arrow"></span> </a>
    <ul class="sub-menu">
