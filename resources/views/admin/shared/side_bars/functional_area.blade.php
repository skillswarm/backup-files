<li class="nav-item {{ (request()->segment(2) == 'list-functional-areas'||request()->segment(2) == 'create-functional-area'||request()->segment(2) == 'sort-functional-areas') ? 'open active' : '' }} "> <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-university" aria-hidden="true"></i> <span class="title">Functional Areas</span> <span class="arrow"></span> </a>
    <ul class="sub-menu">
