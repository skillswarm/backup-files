<li class="nav-item {{ (request()->segment(2) == 'list-cities'||request()->segment(2) == 'create-city'||request()->segment(2) == 'sort-cities') ? 'open active' : '' }} "> <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-globe" aria-hidden="true"></i> <span class="title">Cities</span> <span class="arrow"></span> </a>
    <ul class="sub-menu">
