<li class="nav-item {{ (request()->segment(2) == 'list-ownership-types'||request()->segment(2) == 'create-ownership-type'||request()->segment(2) == 'sort-ownership-types') ? 'open active' : '' }} "> <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-user" aria-hidden="true"></i> <span class="title">Ownership Types</span> <span class="arrow"></span> </a>
    <ul class="sub-menu">
