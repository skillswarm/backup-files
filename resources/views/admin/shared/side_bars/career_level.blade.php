<li class="nav-item {{ (request()->segment(2) == 'list-career-levels'||request()->segment(2) == 'create-career-level'||request()->segment(2) == 'sort-career-levels') ? 'open active' : '' }} "> <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-bar-chart" aria-hidden="true"></i> <span class="title">Career Levels</span> <span class="arrow"></span> </a>
    <ul class="sub-menu">
