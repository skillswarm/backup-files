<li class="nav-item {{ (request()->segment(2) == 'list-marital-statuses'||request()->segment(2) == 'create-marital-status'||request()->segment(2) == 'sort-marital-statuses') ? 'open active' : '' }} "> <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-mars-double" aria-hidden="true"></i> <span class="title">Marital Statuses</span> <span class="arrow"></span> </a>
    <ul class="sub-menu">
