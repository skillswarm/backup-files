<li class="nav-item {{ (request()->segment(2) == 'list-degree-levels'||request()->segment(2) == 'create-degree-level'||request()->segment(2) == 'sort-degree-levels') ? 'open active' : '' }} "> <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-level-up" aria-hidden="true"></i> <span class="title">Degree Levels</span> <span class="arrow"></span> </a>
    <ul class="sub-menu">
