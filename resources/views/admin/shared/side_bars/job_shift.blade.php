<li class="nav-item {{ (request()->segment(2) == 'list-job-shifts'||request()->segment(2) == 'create-job-type'||request()->segment(2) == 'sort-job-shifts') ? 'open active' : '' }} "> <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-black-tie" aria-hidden="true"></i> <span class="title">Job Shifts</span> <span class="arrow"></span> </a>
    <ul class="sub-menu">
