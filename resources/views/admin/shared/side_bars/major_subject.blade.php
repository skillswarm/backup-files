<li class="nav-item {{ (request()->segment(2) == 'list-major-subjects'||request()->segment(2) == 'create-major-subject'||request()->segment(2) == 'sort-major-subjects') ? 'open active' : '' }} "> <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-book" aria-hidden="true"></i> <span class="title">Major Subjects</span> <span class="arrow"></span> </a>
    <ul class="sub-menu">
