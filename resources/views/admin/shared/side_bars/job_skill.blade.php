<li class="nav-item {{ (request()->segment(2) == 'list-job-skills'||request()->segment(2) == 'create-job-skill'||request()->segment(2) == 'sort-job-skills') ? 'open active' : '' }} "> <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-area-chart" aria-hidden="true"></i> <span class="title">Job Skills</span> <span class="arrow"></span> </a>
    <ul class="sub-menu">
