<li class="nav-item {{ (request()->segment(2) == 'list-genders'||request()->segment(2) == 'create-gender'||request()->segment(2) == 'sort-genders') ? 'open active' : '' }} "> <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-venus-double" aria-hidden="true"></i> <span class="title">Genders</span> <span class="arrow"></span> </a>
    <ul class="sub-menu">
