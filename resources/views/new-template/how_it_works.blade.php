  ...
  <div class="block ">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="how-works">
            <div class="how-workimg"><img src="{{ asset('EdgeJobPortal/hw1.jpg') }}" alt="" /></div>
          ...
          <div class="how-works flip">
            <div class="how-workimg"><img src="{{ asset('EdgeJobPortal/hw2.jpg') }}" alt="" /></div>
            <div class="how-work-detail">
              <div class="how-work-box">
                <span>2</span>
          ...
          <div class="how-works">
            <div class="how-workimg"><img src="{{ asset('EdgeJobPortal/hw3.jpg') }}" alt="" /></div>
            <div class="how-work-detail">
              <div class="how-work-box">
                <span>3</span>
