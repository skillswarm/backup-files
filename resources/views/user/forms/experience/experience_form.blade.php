<div class="modal-body">
    <div class="form-body">
        ...
        <div class="formrow" id="div_country_id">
            <?php
            $country_id = (isset($profileExperience) ? $profileExperience->country_id : 101);
            ?>
        ...
        <div class="formrow" id="div_description">
            <textarea name="description" class="form-control" id="description" placeholder="{{__('Experience description')}}" style="margin-bottom: 15px;">{{(isset($profileExperience)? $profileExperience->description:'')}}</textarea>
