<div class="modal-body">
    <div class="form-body">
        ...
        <div class="formrow" id="div_description">
            <textarea name="description" class="form-control" id="description" placeholder="{{__('Project description')}}" style="margin-bottom: 15px;">{{(isset($profileProject)? $profileProject->description:'')}}</textarea>
